...
<div class="col-md-12 col-sm-12 text-center">
    ...
    <strong><p style="font-size: 48px; "> ڕاپۆرتی ئەو کڕیارانەی کە قەرزدانوەیان نییە </p> </strong>
    </br>
    </br>
</div>
</div>
...
@foreach ($customers as $customer)
        ...
        @continue($customer->customerDebt()==0)
   
    <tr>
        <td class="col-print-11">{{$customer->daysFromLastDebtPayment()}}</td>
