...
<head>
  ...
  <!-- Theme Styles -->
  <link href="{{asset('css/theme_style1.css')}}" rel="stylesheet" />
...
<body style="font-family: 'Merriweather', serif; direction:rtl;"
  ...
  <div class="modal fade" id="deleteTreatmentOrTest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
